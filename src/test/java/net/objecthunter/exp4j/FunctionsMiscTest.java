...
public class FunctionsMiscTest {
    ...
    public void testInf() {
        ...
        Assertions.assertEquals(Double.POSITIVE_INFINITY, inf.evaluate(), 0d);
    }
    ...
    public void testInf2() {
        ...
        ValidationResult vr = inf.validate();
        Assertions.assertTrue(vr.isValid());
        Assertions.assertTrue(Double.isInfinite(inf.evaluate()));
        Assertions.assertEquals(Double.POSITIVE_INFINITY, inf.evaluate(), 0d);
    }
    ...
    public void testInf4() {
        ...
        Assertions.assertTrue(vr.isValid());
        Assertions.assertTrue(Double.isInfinite(inf.evaluate()));
        Assertions.assertEquals(Double.NEGATIVE_INFINITY, inf.evaluate(), 0d);
    }
    ...
    public void testIsNaN() {
        ...
        ValidationResult vr = inf.validate();
        Assertions.assertTrue(vr.isValid());
        Assertions.assertEquals(1.0, inf.evaluate(), 0d);
    }
    ...
    public void testIsNaN2() {
        ...
        ValidationResult vr = inf.validate();
        Assertions.assertTrue(vr.isValid());
        Assertions.assertTrue(Double.isNaN(inf.evaluate()));
    }
    ...
    public void testIsNaN3() {
        ...
        ValidationResult vr = inf.validate();
        Assertions.assertTrue(vr.isValid());
        Assertions.assertEquals(0.0, inf.evaluate(), 0d);
    }
    ...
    public void testMin() {
        ...
        Assertions.assertTrue(vr.isValid());
        Assertions.assertEquals(-10.0, min.evaluate(), 0d);
    }
    ...
    public void testMin2() {
        ...
        ValidationResult vr = min.validate();
        Assertions.assertTrue(vr.isValid());
        Assertions.assertEquals(2.0, min.evaluate(), 0d);
    }
    ...
    public void testMin3() {
        ...
        ValidationResult vr = min.validate();
        Assertions.assertTrue(vr.isValid());
        Assertions.assertEquals(1.0, min.evaluate(), 0d);
    }
    ...
    public void testMax3() {
        ...
        ValidationResult vr = min.validate();
        Assertions.assertTrue(vr.isValid());
        Assertions.assertEquals(20.0, min.evaluate(), 0d);
    }
    ...
    public void testGcd() {
        ...
        Assertions.assertTrue(vr.isValid());
        Assertions.assertEquals(2.0, gcd.evaluate(), 0d);
    }
    ...
    public void testGcd3() {
        ...
        ValidationResult vr = gcd.validate();
        Assertions.assertTrue(vr.isValid());
        Assertions.assertEquals(1.0, gcd.evaluate(), 0d);
    }
    ...
    public void testGcd5() {
        ...
        ValidationResult vr = gcd.validate();
        Assertions.assertTrue(vr.isValid());
        Assertions.assertEquals(10.0, gcd.evaluate(), 0d);
    }
    ...
    public void testLcm() {
        ...
        Assertions.assertTrue(vr.isValid());
        Assertions.assertEquals(10.0, lcm.evaluate(), 0d);
    }
    ...
    public void testLcm3() {
        ...
        ValidationResult vr = lcm.validate();
        Assertions.assertTrue(vr.isValid());
        Assertions.assertEquals(20.0, lcm.evaluate(), 0d);
    }
    ...
    public void testLcm4() {
        ...
        ValidationResult vr = lcm.validate();
        Assertions.assertTrue(vr.isValid());
        Assertions.assertEquals(12.0, lcm.evaluate(), 0d);
    }
    ...
    public void testAbsortion() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            Assertions.assertEquals(v1, Math.round(vars.get("x")), 0d);
            Assertions.assertEquals(v2, Math.round(vars.get("x")), 0d);
        }
    }
    ...
    public void testDistribution() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            double v1 = e1.setVariables(vars).evaluate();
            double v2 = e2.setVariables(vars).evaluate();
            Assertions.assertEquals(v1, v2, 0d);
        }
    }
    ...
    public void testRound3() {
        ...
        Assertions.assertEquals(2.0, e1.evaluate(), 0d);
    }
    ...
    public void testd2r2() {
        ...
        Assertions.assertEquals(Math.PI / 2, e1.evaluate(), 0d);
    }
    ...
    public void testr2d2() {
        ...
        Assertions.assertEquals(180.0, e1.evaluate(), 0d);
    }
    ...
    public void testr2d2r() {
        ...
        for (int i = 0; i < 50; i++) {
            ...
            Assertions.assertEquals(x, e1.setVariable("x", x).evaluate(), 1e-8d);
        }
    }
    ...
    public void testGetFunctionNonExistent() {
        Assertions.assertNull(FunctionsMisc.getFunction("foo"));
    }

    @Test
    public void testGetFunctionNull() {
        Assertions.assertThrowsExactly(NullPointerException.class, () -> Assertions.assertNull(FunctionsMisc.getFunction(null)));
    }
}
