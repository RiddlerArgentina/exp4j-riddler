...
public class ShuntingYardTest {
    ...
    public void testShuntingYard7() {
        ...
        Token[] tokens = ShuntingYard.convertToRPN(false, expression, null, userOperators, null, true);
        assertNumberToken(tokens[0], 2d);
        assertNumberToken(tokens[1], 2d);
    ...
    public void testShuntingYard9() {
        ...
        Token[] tokens = ShuntingYard.convertToRPN(false, "1$", null, userOperators, null, true);
