...
public class TokenizerUnknownTokenOrVariableTest {
    ...
    public void testTokenizationOfUnknownVariable() throws Exception {
        final Tokenizer tokenizer = new Tokenizer("3 + x", null, null, null, true, true, true);
    ...
    public void testTokenizationOfUnknownVariable2Details() throws Exception {
        final Tokenizer tokenizer = new Tokenizer("x + 3", null, null, null, true, true, true);
    ...
    public void testTokenizationOfUnknownFunction() throws Exception {
        final Tokenizer tokenizer = new Tokenizer("3 + p(1)", null, null, null, true, true, true);
        while (tokenizer.hasNext()) {
            tokenizer.nextToken();
        }
    }
    ...
    public void testTokenizationOfUnknownFunction2Details() throws Exception {
        ...
        final Tokenizer tokenizer = new Tokenizer("p(1) + 3", null, null, null, true, true, true);
